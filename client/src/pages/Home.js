  ...
  return (
    <Container>
      <body className='container' style={{ marginLeft: '25%', marginTop: '10%', display: 'inline-block', color: '#000080' }}>
        <h1 style={{ fontSize: '45px' }}>Career Optimizer</h1>
        <br />
        ...
        <div className="row">
          <div className="col-lg-12">
            <Link className="btn btn-warning" to="/createaccount" style={{ margin: '0.25em 1em', color: '#000080' }}>Create account</Link>
    ...
    <section class='container' style={{display: 'block', height: '230px', marginRight: 'auto', marginLeft: 'auto', background: '#00b285', position: 
      'relative' }}>
